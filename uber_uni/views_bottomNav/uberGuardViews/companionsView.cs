...
namespace uber_uni
{
    public class companionsView : ContentPage
        ...
        Button btn = new Button { Text = "Add new companion", Margin = 20, Padding = 20, WidthRequest = 200, HorizontalOptions = LayoutOptions.Center, BackgroundColor = Color.Black, HeightRequest = 50, TextColor = Color.White };
        ...
        private DataTemplate datatemplate()
        {
            return new DataTemplate(() =>
             {
                 var stack = new StackLayout {  Orientation =StackOrientation.Horizontal, HorizontalOptions = LayoutOptions.Start, VerticalOptions = LayoutOptions.Center };
